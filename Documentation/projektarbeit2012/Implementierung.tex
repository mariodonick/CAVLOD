...
Klasse \Code{Partitionierung} weitergegeben. Dort werden diese in Datenbl{\"o}cke
...
W{\"a}hrend der Entwicklung des Moduls \Code{Sender} wurde eine weitere Eigenschaft
...
\todo{LINK modern c++ design generic programming and design patterns applied}
...
die Grundprinzipien der objektorientierten Programmierung \todo{go to
objektorientierung + clean code + patterns kompakt (ja die behandeln alle die
grundlagen der OOP^^)} eingehalten werden.
