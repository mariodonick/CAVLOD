...
(GUI), dies erm{\"o}glicht eine Chat Kommunikation via CRODT
...
Grundlegende Funktionalit{\"a}t der GUI entspricht der eines {\"u}blichen
...
rechten unteren Bereich der GUI. Nach erfolgter Eingabe kann die Nachricht
