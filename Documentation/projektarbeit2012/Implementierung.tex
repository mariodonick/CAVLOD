...
Klasse \Code{Partitionierung} weitergegeben. Dort werden diese, abh{\"a}ngig von
...
Datenbl{\"o}cke werden in einem extra Modul namens \gls{CRODM} berechnet und den
Modulen {\"u}bergeben. Anhand dieser wird der Datenblock in die Datenstruktur
