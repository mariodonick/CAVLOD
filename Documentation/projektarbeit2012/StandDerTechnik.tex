...
Way Delay} auf einen \gls{QoI}-Fall gemappt werden. Steigt z.B. die CD und sinkt
zugleich die CP so resultiert daraus eine steigende Bandbreite. Um die
...
Bestandteile einer Ontologie:
 ...
 bestehen (z.B. Professor:Meier $\rightarrow$ unterrichtet $\rightarrow$
 Student:Mueller).
 Relationen werden auch als Eigenschaften bezeichnet. 
 \newline
