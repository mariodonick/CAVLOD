...
\gls{ASCII}\footnote{\gls{ASCII} ist eine 7-Bit Zeichencodierung.}\todo{quelle
f{\"u}r ascii}-Zeichensatz enthalten sind, ben{\"o}tigen die doppelte L{\"a}nge.
...
Aufgrund der Tatsache, dass eine Kompression des Datenblockheaders möglich ist,
und damit die Gr{\"o}{\ss}e der Variablen unterschiedlich sein kann, wird
f{\"u}r die Variablen festgelegt, dass f{\"u}r jeden Wert die h{\"o}chste
auftretende Bitzahl aufgerundet zur n{\"a}chsten Zweierpotenz als Byte verwendet
wird. Dadurch wird das Laden und Speichern stark vereinfacht. Der dabei
auftretende zus{\"a}tzliche Speicherplatzbedarf kann vernachl{\"a}ssigt werden.
\newline 
