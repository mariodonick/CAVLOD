...
void UDPSocket::sendData( unsigned char* data, const unsigned int& length, const char* s_addr, const unsigned int& s_port)
{
  ...
  n_c=sendto(sock_c, &data, length, 0 ,(sockaddr *)&server_c,length_c);
