...
(American Standard Code for Information Interchange): Ist eine 7-Bit Zeichencodierung.}\todo{quelle f{\"u}r ascii}
...
\todo{erkl{\"a}ren was callback ist} ausgel{\"o}st. Bei einem Callback wird
