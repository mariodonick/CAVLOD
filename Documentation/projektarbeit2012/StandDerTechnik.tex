...
Temperaturschwankungen. Das genutzte Betriebssystem ist VxWorks \todo{quelle}.
...
\todo{einfach die anderen 5 sachen noch mit aufzählen?}
...
Das DTN Bundle Protokoll agiert als ein Overlay \todo{fussnote/glosar was
gemeint ist} auf dem Transport Layer. Die Abbildung \ref{fig:PSSBN} zeigt den
