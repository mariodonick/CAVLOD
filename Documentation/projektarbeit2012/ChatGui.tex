...
unten links) sowie der Priorit{\"a}tenliste (Abb 1. oben rechts\todo{ angaben
sind nicht so ganz präzise wegen 2ten empfangsteil}) und den Bedienelementen
(Abb 1. unten rechts). \todo{abbildung mit refs}
...
\textbf{Regeln des GUI Designentwurfs nach Jakob Nielsen:} \todo{quelle, in gui
tooltips einfügen}
...
GUI verhindert. \todo{oben unten eventl durch nummerierung darstellen?}
