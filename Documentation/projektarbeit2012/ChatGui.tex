...
durch Dr{\"u}cken des Buttons \Code{Senden} oder per Shortcut (Regel
...
Klassendiagramm.
Die Hauptklasse \Code{ChatGui} erbt von der Klasse \Code{QMainWindow}. Diese
wird durch Qt bereitgestellt und erstellt sowie verwaltet ein einfaches Fenster.
In dieser wird das Layout mit der Klasse \Code{Ui::ChatGui} integriert.
Der Austausch der Daten mit den Layout erfolgt über einen Pointer auf die
Klasse \Code{Ui::ChatGui}. \newline
...
\Code{ReceiverModulIF} und \Code{SenderModulIF} genutzt. Diesen werden die Daten
...
Daten in der Klasse \Code{UniversalDecoder} gespeichert und gleichzeitig
sortiert. Die sortierten Daten werden danach in dem Empfangsteil des \gls{GUI}
über die Klasse \Code{Ui::ChatGui} dargestellt.

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{KlassendiagrammGui.pdf}
...
der Implementierung des ROTP und des eigens daf{\"u}r entwickelten Chat-GUI.
...
und der GUI). Zudem wurden die dabei verwendeten Programmiertechniken und
