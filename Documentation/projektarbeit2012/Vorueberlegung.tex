...
selbiger im weiteren Entwicklungsverlauf des Protokolls unabdingbar. Sie sind
jedoch (da nicht verwendet) kein Bestandteil dieser Arbeit.
...
bezeichnet eine Station einer Route auf dem Weg zum Ziel (Knoten)} count ist
dabei in einem Szenario der interplanetaren Kommunikation derzeit eher unrealistisch, da zumeist eine Punkt-zu-Punkt Verbindung anvisiert wird (kein intensives Routing {\"u}ber eine Vielzahl an Stationen). Somit
